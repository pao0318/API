...
export const MongoBookSchema = new Schema({
    ...
    genre: {
        ...
        required: true,
        enum: [
            Constants.BOOK.GENRE.ADVENTURE,
            Constants.BOOK.GENRE.DETECTIVE,
            Constants.BOOK.GENRE.FANTASY,
            Constants.BOOK.GENRE.HORROR,
            Constants.BOOK.GENRE.SCIENCE_FICTION,
            Constants.BOOK.GENRE.THRILLER,
        ],
    },
    picture: {
        type: String,
