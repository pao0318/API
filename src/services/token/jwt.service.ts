...
export class JwtService {
    ...
    private _getPayloadOrThrowError(type: Token, token: string): ITokenPayload {
        const secret = this._getTokenProperties(type).secret;
        let payload = {} as ITokenPayload;
